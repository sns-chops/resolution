...
class Instrument(object):
    ...
    def getResolution(self, Etrans=None, Ei_in=None, frequency=None, split_contribution=False):
        """
        ...
        v_van, outdict, _ = self.getVanVar(Ei, frequency, Etrans)
        ...
        if split_contribution:
            ...
            for k, v in outdict.iteritems():
                newoutdict[k] = (2 * E2V * np.sqrt(Ef**3 * v)) / x2
            newoutdict['total'] = van
            return newoutdict
        else:
            return van
